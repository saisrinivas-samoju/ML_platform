...
$('#microsoft').attr('class','')
       ...
       $('#nav-directory').html("<li><a><span>Visited directory: </span></a></li>");
         $("#current_folder_name").val("");
            $("#uploadFolder").val("");
                     $("#folder").html("");
       $("#folder").html("<div class='col-md-1 col-md-offset-5'><i style='color:#000000;' class='fas fa-sync fa-spin fa-1x'></i></div>");
                               ...
                               if(i==0)
                                   {
                                        ...
                                        {
                                        $("#folder").html('<div class="col-md-2 " ><input class="deletable" id="selected-folder-'+response['directory_list'][i]+'"  value="'+response['directory_list'][i]+'" type="checkbox"  /><i style="color:rgb(10, 10, 10);padding:20px;" class="fas fa-folder fa-pull-top fa-3x"></i><br /><a  class="'+class_folder_name+'">'+response['directory_list'][i]+'</a></div>');
                                        }
                                        else
                                        {
                                        $("#folder").html('<div class="col-md-2 " ><input class="deletable-file" id="selected-folder-'+response['directory_list'][i]+'"   value="'+response['directory_list'][i]+'"  type="checkbox"  /><i style="color:#000000;padding:20px;" class="fas fa-file fa-pull-top fa-3x"></i><br /><a class="'+class_file_name+'">'+response['directory_list'][i]+'</a></div>');
                                   ...
                                   if (response['directory_list'][i].indexOf(".")<0)
                                        {
                                        $("#folder").append('<div class="col-md-2 " ><input class="deletable" id="selected-folder-'+response['directory_list'][i]+'"   value="'+response['directory_list'][i]+'"  type="checkbox"  /><i style="color:rgb(10, 10, 10);padding:20px;" class="fas fa-folder fa-pull-top fa-3x"></i><br /><a  class="'+class_folder_name+'">'+response['directory_list'][i]+'</a></div>');

                                        }
                                        else
                                        {
                                        $("#folder").append('<div class="col-md-2 " ><input class="deletable-file" id="selected-folder-'+response['directory_list'][i]+'"   value="'+response['directory_list'][i]+'"  type="checkbox"  /><i style="color:#000000;padding:20px;" class="fas fa-file fa-pull-top fa-3x"></i><br /><a class="'+class_file_name+'">'+response['directory_list'][i]+'</a></div>');
...
$("#new-folder-status").html("<div class='col-md-1 col-md-offset-5'><i style='color:#000000;' class='fas fa-sync fa-spin fa-1x'></i></div>");
                ...
                success: function(response)
                    {
                        ...
                        $("#new-folder-name").val("");
                           ...
                           $("#folder").append('<div class="col-md-2 " ><input class="deletable" id="selected-folder-'+response['folder_name']+'"  value="'+response['folder_name']+'" type="checkbox"  /><i style="color:rgb(10, 10, 10);padding:20px;" class="fas fa-folder fa-pull-top fa-3x"></i><br /><a  class="'+class_folder_name+'">'+response['folder_name']+'</a></div>');
                ...
                success: function(response)
                    {
                        ...
                        if(response['status']==true)
                        {
                           ...
                           for (var i=0;i<response['n_directory'];i++)
                           {
                               if(i==0)
                                   {
                                        $("#folder").html('<div class="col-md-2 " ><i style="color:rgb(10, 10, 10);padding:20px;" class="fas fa-folder fa-pull-top fa-3x"></i><br /><a  class="folder-name">'+response['directory_list'][i]+'</a></div>');
                                   }
                               else
                                   {
                                        $("#folder").append('<div class="col-md-2 " ><i style="color:rgb(10, 10, 10);padding:20px;" class="fas fa-folder fa-pull-top fa-3x"></i><br /><a  class="folder-name">'+response['directory_list'][i]+'</a></div>');
                                    }
...
$('#selected-file').change(function(){
 ...
 $("#file-upload-status").html("<div class='col-md-1 col-md-offset-5'><i style='color:#000000;' class='fas fa-sync fa-spin fa-1x'></i></div>");
                    ...
                    for (var i=0;i<response['n_file_uploaded'];i++)
                           {
                                        ...
                                        $("#folder").append('<div class="col-md-2 " ><input class="deletable-file" id="selected-folder-'+response['uploaded_files_on_cloud']+'"  value="'+response['uploaded_files_on_cloud']+'" type="checkbox"  /><i style="color:#000000;padding:20px;" class="fas fa-file fa-pull-top fa-3x"></i><br /><a class="'+class_file_name+'">'+response['uploaded_files_on_cloud'][i]+'</a></div>');
